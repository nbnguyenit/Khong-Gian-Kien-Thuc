...
import { Pagination, Comment } from '../../../../shared/models';
import { NotificationService, CommentsService } from '../../../../shared/services';
...
export class CommentsComponent implements OnInit, OnDestroy {
  ...
  deleteItemsConfirm(icommentId, knowledgeBaseId) {
    this.blockedPanel = true;
    this.subscription.add(this.commentsService.delete(knowledgeBaseId, icommentId).subscribe(() => {
