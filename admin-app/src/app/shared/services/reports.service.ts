...
export class ReportsService extends BaseService {
    ...
    getAllPaging(knowledgeBaseId, filter, pageIndex, pageSize) {
        return this.http.get<Pagination<Report>>(`${environment.apiUrl}/api/knowledgeBases/${knowledgeBaseId}/reports?pageIndex=${pageIndex}&pageSize=${pageSize}&filter=${filter}`, { headers: this._sharedHeaders })
