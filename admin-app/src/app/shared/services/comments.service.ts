...
export class CommentsService extends BaseService {
    ...
    getAllPaging(knowledgeBaseId, filter, pageIndex, pageSize) {
        return this.http.get<Pagination<Comment>>(`${environment.apiUrl}/api/knowledgeBases/${knowledgeBaseId}/comments?pageIndex=${pageIndex}&pageSize=${pageSize}&filter=${filter}`, { headers: this._sharedHeaders })
