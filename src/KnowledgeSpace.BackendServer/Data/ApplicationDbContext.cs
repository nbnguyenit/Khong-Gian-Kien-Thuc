...
namespace KnowledgeSpace.BackendServer.Data
{
    public class ApplicationDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            /*
            // Data Seed - use cach nay moi lan phai Migration moi duoc (Do vay dung cach khac run la duoc "DbInitiliazer")
            builder.Entity<LabelInKnowledgeBase>().HasData(
                new LabelInKnowledgeBase() {Key = "", Value = ""},
                new LabelInKnowledgeBase() {Key = "", Value = ""}
            );
            */
        }
