...
namespace KnowledgeSpace.WebPortal
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // --- Tích hợp SSO với Identity cho Web Portal ---
            ...
            builder.AddFluentValidation(fv => fv.RegisterValidatorsFromAssemblyContaining<KnowledgeBaseCreateRequestValidator>());
            ...
            services.TryAddSingleton<IHttpContextAccessor, HttpContextAccessor>();// TryAddSingleton: Cho phep truy cap http context (Try: không cho phep "override <IHttpContextAccessor, HttpContextAccessor>()" chi cho phep instance su dung interface nay)
